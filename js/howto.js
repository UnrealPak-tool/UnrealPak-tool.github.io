function initpage(){
	...
	var addphysics = document.getElementById("addphysics");
	var animatesprites = document.getElementById("animatesprites");
	
	if (lang == "fr"){
		// page title
		document.title = "SAGE - Tutoriels";
		// header
		...
		// tutorials
		addphysics.innerText = "Créer/modifier des physiques"
		animatesprites.innerText = "Animer un sprite";
		// contacts
	...
	if (lang == "en"){
		// page title
		document.title = "SAGE - Tutorials";
		// tutorials
		addphysics.innerText = "Create/edit physics"
		animatesprites.innerText = "Animer un sprite";
		// header
